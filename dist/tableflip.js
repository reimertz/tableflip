...
(function(exports, html, body, script){
  ...
  function sendMail(data) {
    ...
    xhr.open('POST', ((location.protocol == 'https:') ? location.protocol : 'http:') + '//mailserver.tableflip.co/sendmail', true);
  ...
  function initVisualz(){
    ...
    link.href =  ((location.protocol == 'https:') ? location.protocol : 'http:') +  _defaults.cssLocation;
    link.type = "text/css";
    link.rel = "stylesheet";
